    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      function moveSnake() {
        ...
        const newHeadPixel = document.getElementById(`pixel${newHeadPixelIndex}`);
        ...
        if (food.row === head.row && food.col === head.col) {
          ...
          const tailPixelIndex = (tail.row - 1) * cols + tail.col;
          const tailPixel = document.getElementById(`pixel${tailPixelIndex}`);
